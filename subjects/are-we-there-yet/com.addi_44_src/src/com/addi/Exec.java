...
public class Exec
{
    static {
    	...
    	//Utils.dlopentest("/data/data/com.example.hellojni/lib/libpcre.so");
    	//Utils.dlopentest("/data/data/com.example.hellojni/lib/libcruft.so");
    	//Utils.dlopentest("/data/data/com.example.hellojni/lib/liboctave.so");
    	//Utils.dlopentest("/data/data/com.example.hellojni/lib/liboctinterp.so");
    	System.loadLibrary("gnustl_shared");
    	//System.loadLibrary("pcre");
    	//System.loadLibrary("cruft");
    	//System.loadLibrary("octave");
    	//System.loadLibrary("octinterp");
    	System.loadLibrary("octaveLib");     
    }
