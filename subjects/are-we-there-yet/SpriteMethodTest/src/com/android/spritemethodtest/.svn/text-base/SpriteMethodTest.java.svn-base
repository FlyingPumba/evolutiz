...
public class SpriteMethodTest extends Activity {
    ...
    protected void initializeIntent(Intent i) {
        ...
        // MAYUR final EditText editText = (EditText) findViewById(R.id.spriteCount);
        // MAYUR final String spriteCountText = editText.getText().toString(); 
        final int stringCount = 10; // MAYUR Integer.parseInt(spriteCountText);
